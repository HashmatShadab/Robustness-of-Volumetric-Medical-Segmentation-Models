...
for ((i=0; i<6; i++)); do
  ...
  echo "PGD Attack on Abdomen CT with PGD eps 4 $model_name"
  ...
  echo "PGD Attack on Abdomen CT with PGD eps 8 $model_name"
  python wb_attack.py  --model_name $model_name   --in_channels 1 --out_channel 14 --feature_size=16 --checkpoint_path $ckpt_path \
  --dataset abdomen --data_dir=$DATA_DIR --json_list $JSON_LIST --slice_batch_size $SLICE_BS  \
  ...
  echo "PGD Attack on Abdomen CT with CosPGD eps 4 $model_name"
  python wb_attack.py  --model_name $model_name   --in_channels 1 --out_channel 14 --feature_size=16 --checkpoint_path $ckpt_path \
  --dataset abdomen --data_dir=$DATA_DIR --json_list $JSON_LIST --slice_batch_size $SLICE_BS  \
  ...
  echo "PGD Attack on Abdomen CT with CosPGD eps 8 $model_name"
  python wb_attack.py  --model_name $model_name   --in_channels 1 --out_channel 14 --feature_size=16 --checkpoint_path $ckpt_path \
  --dataset abdomen --data_dir=$DATA_DIR --json_list $JSON_LIST --slice_batch_size $SLICE_BS  \
  ...
  echo "PGD Attack on Abdomen CT with FGSM eps 4 $model_name"
  python wb_attack.py  --model_name $model_name   --in_channels 1 --out_channel 14 --feature_size=16 --checkpoint_path $ckpt_path \
  --dataset abdomen --data_dir=$DATA_DIR --json_list $JSON_LIST --slice_batch_size $SLICE_BS  \
  ...
  echo "PGD Attack on Abdomen CT with FGSM eps 8 $model_name"
  python wb_attack.py  --model_name $model_name   --in_channels 1 --out_channel 14 --feature_size=16 --checkpoint_path $ckpt_path \
  --dataset abdomen --data_dir=$DATA_DIR --json_list $JSON_LIST --slice_batch_size $SLICE_BS  \
  ...
  echo "PGD Attack on Abdomen CT with GN std 4 $model_name"
  python wb_attack.py  --model_name $model_name   --in_channels 1 --out_channel 14 --feature_size=16 --checkpoint_path $ckpt_path \
  --dataset abdomen --data_dir=$DATA_DIR --json_list $JSON_LIST  --slice_batch_size $SLICE_BS \
  ...
  #
  echo "PGD Attack on Abdomen CT with GN std 8 $model_name"
  python wb_attack.py  --model_name $model_name   --in_channels 1 --out_channel 14 --feature_size=16 --checkpoint_path $ckpt_path \
  --dataset abdomen --data_dir=$DATA_DIR --json_list $JSON_LIST --slice_batch_size $SLICE_BS  \
  ...
  echo "PGD Attack on Abdomen CT with VAFA-3D with qmax 10 $model_name"
  python wb_attack.py  --model_name $model_name   --in_channels 1 --out_channel 14 --feature_size=16 --checkpoint_path $ckpt_path \
  --dataset abdomen --data_dir=$DATA_DIR --json_list $JSON_LIST --slice_batch_size $SLICE_BS  \
  ...
  echo "PGD Attack on Abdomen CT with VAFA-3D with qmax 20 $model_name"
  python wb_attack.py  --model_name $model_name   --in_channels 1 --out_channel 14 --feature_size=16 --checkpoint_path $ckpt_path \
  --dataset abdomen --data_dir=$DATA_DIR --json_list $JSON_LIST --slice_batch_size $SLICE_BS  \
  ...
  echo "PGD Attack on Abdomen CT with VAFA-3D with qmax 30 $model_name"
  python wb_attack.py  --model_name $model_name   --in_channels 1 --out_channel 14 --feature_size=16 --checkpoint_path $ckpt_path \
  --dataset abdomen --data_dir=$DATA_DIR --json_list $JSON_LIST --slice_batch_size $SLICE_BS  \

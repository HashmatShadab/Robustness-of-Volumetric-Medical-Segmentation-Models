...
def get_umamba_bot_2d(input_channels=1, num_stages=7, features_per_stage= [32, 64, 128, 256, 512, 512, 512],
...
def get_umamba_bot_3d(input_channels=1, num_stages=6, features_per_stage=[32, 64, 128, 256, 320, 320],

...
def get_swin_umamba_d_2d(input_channels=1, num_classes=14,
    ...
    if os.path.exists(pretrain_path):
        model = load_pretrained_ckpt(model, num_input_channels=input_channels, ckpt_path=pretrain_path)
    else:
        print("Pretrained weights not found. Initializing model without pretrained weights.")

...
def get_lmaunet_2d(input_channels=1, num_stages=7, features_per_stage= [32, 64, 128, 256, 512, 512, 512],
    ...
    conv_or_blocks_per_stage = {'n_conv_per_stage': [2, 2, 2, 2, 2, 2, 2],
...
def get_lmaunet_3d(input_channels=1, num_stages=6, features_per_stage=[32, 64, 128, 256, 320, 320],

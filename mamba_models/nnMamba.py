...
def get_nnmamba_3d(input_channels=1, num_classes=14):
    model = nnMambaSeg(in_ch=input_channels, number_classes=num_classes)
    return model

if __name__ == "__main__":
    from torchinfo import summary
    model = nnMambaSeg(in_ch=1, number_classes=14).cuda()

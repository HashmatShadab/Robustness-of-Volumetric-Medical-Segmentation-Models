...
def get_umamba_enc_2d(input_channels=1, num_stages=7, features_per_stage= [32, 64, 128, 256, 512, 512, 512],
    ...
    dim = 2  # taken from nnunet >> len(configuration_manager.conv_kernel_sizes[0])
    ...
    conv_or_blocks_per_stage =  {'n_conv_per_stage': [2, 2, 2, 2, 2, 2, 2], 'n_conv_per_stage_decoder': [2, 2, 2, 2, 2, 2]}
...
def get_umamba_enc_3d(input_channels=1, num_stages=6, features_per_stage=[32, 64, 128, 256, 320, 320],
